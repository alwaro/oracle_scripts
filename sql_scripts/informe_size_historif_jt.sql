...
prompt
prompt ===============================================================================================
prompt         Resumen total = Archivos de datos + Archivos temporales + Redo Log + Control Files
prompt ===============================================================================================
PROMPT
PROMPT
SELECT SUM(bytes)/1024/1024/1024 as "Arhivos de datos en Gb" from dba_data_files;
PROMPT
select nvl(sum(bytes),0)/1024/1024/1024 as "Archivos temporales en Gb" from dba_temp_files;
PROMPT
select sum(bytes)/1024/1024/1024 as "Tamaño Redol Log en Gb" from sys.v_$log;
PROMPT
select sum(BLOCK_SIZE*FILE_SIZE_BLKS)/1024/1024/1024 as "Tamaño control file en Gb" from v$controlfile;
spoo off
