-- ===============================================================
-- NAME: sqlhcxec.sql
-- DESCRIPTION: Produces an HTML report with a list of observations based on health-checks performed in and around a SQL statement that may be performing poorly.
-- USAGE: Execute
-- AUTHOR:
-- ---------------------------------------------------------------
SPO sqlhcxec.log
