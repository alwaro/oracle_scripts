-- ===============================================================
-- NAME: get_queries_info.sql
-- DESCRIPTION: Displays info from a query
-- USAGE: Execute (Already has an sql_id)
-- AUTHOR:
-- ---------------------------------------------------------------
...
where --SQL_EXEC_START > to_date('2022-02-24 10:55:00','YYYY-MM-DD HH24:MI:SS') and
       sample_time between to_date('2022-03-14 09:00:00','YYYY-MM-DD HH24:MI:SS') and to_date('2022-03-15 09:30:00','YYYY-MM-DD HH24:MI:SS')
     and user_id in( 
           select user_id from dba_users where oracle_maintained = 'N')  and sql_id in ('584sfzrhg8t0y')
