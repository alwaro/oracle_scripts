-- ===============================================================
-- NAME: rman_size_time_historico.sql
-- DESCRIPTION: Displays the size of RMAN
-- USAGE: Execute
-- AUTHOR:
-- ---------------------------------------------------------------
...
SELECT TO_CHAR(TRUNC(completion_time),'YYYY-MM-DD HH:MM') completion_time, type, round(sum(MB),2) MB, round(sum(elapsed_seconds)/60,2) min
FROM (
SELECT
CASE
