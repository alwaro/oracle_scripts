-- ===============================================================
-- NAME: sesiones1.sql
-- DESCRIPTION: Displays the info of the active sessions from dual.
-- USAGE: Execute
-- AUTHOR:
-- ---------------------------------------------------------------
...
select a.inst_id inst, sid, serial#, substr(program,1,19) prog, a.logon_time, machine, username, osuser, b.sql_id, plan_hash_value, 
sql_text
