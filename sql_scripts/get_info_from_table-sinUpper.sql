-- ===============================================================
-- NAME: get_info_from_table-sinUpper.sql
-- DESCRIPTION: Displays info from a specific table and owner
...
FROM DBA_TABLES t, DBA_SEGMENTS s WHERE
    ...
    s.segment_name='&&Nombre_de_la_tabla' AND
