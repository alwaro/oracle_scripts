-- ===============================================================
-- NAME: cellver.sql (v1.01)
-- DESCRIPTION: Report Exadata cell details from V$CELL_CONFIG
-- USAGE: @cellver.sql
-- AUTHOR:
-- ---------------------------------------------------------------
...
PROMPT Sacando informacion de las celdas a traves de la vista V$CELL_CONFIG....
